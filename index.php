          ...
          <div id="header_left">
            <div id="menu">
              <ul>
                ...
                <li><a href="beforelogintouristlocations.php">Tours</a></li>
                ...
                <button type="submit" name="register">Register</button>
                    ...
                    <form method="post" action="beforelogintouristlocations.php">
                                <h3>
                                    ...
                                    <button type="submit" name="submitlocationtype" >Submit</button>
                            </h3>
