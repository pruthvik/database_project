...
session_start();
 $sessionid=session_id();
    ...
    $bookinghotelsquery=mysqli_query($dbConn,"SELECT * FROM booking_hotels WHERE user_id =$user_id && status='cancelled'" );
    ?>
          ...
          <div id="header_left">
            <div id="menu">
              <ul>
                ...
                <li><a href="mytourbookings.php.html">MyTour Bookings</a></li>
                ...
                <div class="content_section">
                    <?php
                      ...
                      while($row=mysqli_fetch_assoc($bookinghotelsquery))
                      {
                            ...
                            $booking_hotels_idquery=mysqli_query($dbConn,"SELECT * FROM bookinghotel_customers WHERE booking_hotel_id=$booking_hotels_id && status='cancelled'");
