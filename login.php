...
$idquery=mysqli_query($dbConn,"SELECT user_id FROM USERS WHERE user_email='$email' && user_pass ='$pass'");
...
mysqli_query($dbConn,"INSERT INTO activeusers(active_user_id,session_id) VALUES('$user_id','$session_id')");
            ...
            <div id="menu">
              <ul>
                ...
                <li><a href="afterloginhotels.html">Hotels</a></li>
                 <li><a href="myhotelboking.php">MyHotel Bookings</a></li>
                <li></li>
