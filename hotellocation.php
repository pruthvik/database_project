               ...
               while($row= mysqli_fetch_assoc($query))
{
    ...
    print("<h2>"."Hotel Category:".$row['hotel_category']."</h2>");
     ...
     $hotel_id=$row['hotel_id'];
          $roomsquery=mysqli_query($dbConn,"SELECT * FROM bookinghotel_available WHERE hotel_id=$hotel_id && checkindate='$checkindate' ");
    ...
    echo '<form method="post" action="checksessionhotels.php">
           ...
           <select name="numberofrooms">
             ...
             <option selectted value="single">Single</option>
